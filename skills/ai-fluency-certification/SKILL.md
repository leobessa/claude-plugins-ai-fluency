...
description: "Assess AI fluency proficiency using 5-level certification criteria (A through E) based on demonstrated capabilities across the 4D Framework dimensions."
version: "1.0.0"
---
...
- [ai-4d-framework](../ai-4d-framework/SKILL.md) — The framework being assessed
- [ai-fluency-antipatterns](../ai-fluency-antipatterns/SKILL.md) — What prevents advancement
- [ai-system-governance](../ai-system-governance/SKILL.md) — Organizational context

---

## Learn More

- [Assessment Templates](references/certification-templates.md)
- [Evidence Portfolio Examples](references/evidence-examples.md)
